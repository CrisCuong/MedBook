            ...
            <div class="row">
                ...
                <div class="col-md-6 cell-body" style="margin-top: 50px">
                    <div class="body-content">
                        <h3 class="forgot-password-heading">Enter your phone number</h3>
                        <form action="forgot-password-func.php" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btnForgot">Get OTP</button>
                            </div>    
                        </form>
                    </div>
                </div>
