                        ...
                        <div class="body-content">
                            <form action="change-password.php" method="POST">
                                ...
                                <div class="button-group">
                                    <a href="../patient-panel.php" class="btn btn-primary">Back</a>
...
<?php
    ...
    if (isset($_POST['change_password'])) {
        ...
        $patient_id = $_SESSION['patient_id']; // Đảm bảo session của bệnh nhân đã đăng nhập
        ...
        if (password_verify($current_password, $hashed_password)) {
            if ($new_password === $confirm_password) {
                ...
                if (password_verify($new_password, $hashed_password)) {
                    ...
                    $update_query = "UPDATE patient SET password = ? WHERE patient_id = ?";
                    $update_stmt = $con->prepare($update_query);
                    $update_stmt->bind_param("si", $new_hashed_password, $patient_id);
