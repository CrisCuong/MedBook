                        ...
                        <div class="row register-form">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control"  placeholder="Admin name" name="admin_name"  onkeydown="return numericOnly(event);" required/>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control"  placeholder="Username" name="username" onkeydown="return numericOnly(event);" required/>
                                </div>
                            </div>
                            ...
                            <input type="submit" class="btnRegister" name="adsub1" onclick="return checklen();" value="Register"/>
                        </div>
                    </form>
                </div>
            </div>
